...
## 🎯 Target User: The "Burnt-Out" Head of Engineering
- **Exact Persona**: Head of Engineering or VP of Engineering at a Seed-to-Series B startup (20–100 employees).
- **The Trigger**: They just had a board meeting where the CEO asked, "Why is our 'Cloud & AI' line item up 300% since last quarter?" 
...
- Scrolling **Hacker News** comments on the latest Cursor release to see if they can drop their Copilot subscription.

## 🏘️ Digital Hangouts
- **Subreddits**: `r/cto`, `r/SaaS`, `r/startups`.
- **Slack Groups**: *CTO Connection*, *Lattice Resource for Engineering Leaders*.
- **X Lists**: "AI Infrastructure" lists, following accounts like @swyx or @karpathy.
- **Discord**: *The Pragmatic Engineer* community.
...
- **Primary KPI**: 200 completed audits.
- **Lead Quality**: 15 "High Value" leads (> $1,000/mo in potential savings).
- **Marketplace Velocity**: 5 users attempting to "Sell" their identified credits on the secondary market via the final CTA.
- **Viral Coefficient**: 10% of audits shared on X or LinkedIn.
